                ...
                <div class="col-xl-4 xl-50 col-sm-6 box-col-6" v-for="(course,index) in normalcourses" :key="'normal'+index">
                    <div class="card">
                        <div class="blog-box blog-grid text-center product-box">
                            <div class="product-img"><img class="img-fluid top-radius-blog" :src="getImgUrl1(course.image)" alt="">
                                <div class="product-hover">
                                    <ul>
                                        <li>
                                            <!-- <nuxt-link :to="{ name: '/learning/details', params:{ id: course.id } }"><i class="icon-link"></i> </nuxt-link> -->
...
export default {
    ...
    computed: {
        ...
        // }),
        specialcourses(){
            return useCourseStore().specialcourses
        },
        normalcourses(){
            return useCourseStore().normalcourses
        }
    },
    methods: {
        getImgUrl(filename) {
