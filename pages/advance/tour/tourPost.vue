                        ...
                        <div class="profile-post">
                          ...
                          <div class="post-body">
                            ...
                            <ul class="post-comment">
                              <li>
                                <label><a href="#"><i data-feather="heart"></i>&nbsp;&nbsp;Like<number
                               class="bold counter"
                               ref="number1"
                               :from="0"
                               :to="50"
                              ...
                              <li>
                                <label><a href="#"><i data-feather="message-square"></i>&nbsp;&nbsp;Comment<number
                                class="bold counter"
                                ref="number1"
                               :from="0"
                               :to="70"
                              ...
                              <li>
                                <label><a href="#"><i data-feather="share"></i>&nbsp;&nbsp;share<number
                                class="bold counter"
                                ref="number1"
                                :from="0"
                                :to="20"
...
export default {
   data(){
       return{
            visible: false,
      imgs: [
         ('../../../assets/images/user-profile/post1.jpg'),
      ]
       }
   },
   methods: {
