                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="current-sale-container">
                                                    <ClientOnly>
                                                        ...
                                                        <apexchart height="305" type="bar" :options="apexDashboard.options3" :series="apexDashboard.series3"></apexchart>
                                                    </ClientOnly>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="recent-chart">
                                    ...
                                    <ClientOnly>
                                        ...
                                        <apexchart height="278.7" type="radialBar" :options="apexDashboard.options4" :series="apexDashboard.series4"></apexchart>
                                    </ClientOnly>
                    ...
                    <div class="card-body pt-0">
                        <div class="schedule-container">
                            <ClientOnly>
                                ...
                                <apexchart height="370" type="rangeBar" :options="apexDashboard.options5" :series="apexDashboard.series5"></apexchart>
                            </ClientOnly>
                        </div>
                    </div>
                </div>
                                ...
                                <ul class="user-list">
                                    <li>
                                        <div class="user-icon primary">
                                            <div class="user-box">
                                                <vue-feather class="font-primary" type="user-plus"></vue-feather>
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    <li>
                                        <div class="user-icon success">
                                            <div class="user-box">
                                                <vue-feather class="font-success" type="user-minus"></vue-feather>
                                            </div>
                                        </div>
                                        <div>
                        ...
                        <div class="card growth-wrap">
                            ...
                            <div class="card-body pt-0">
                                <div class="growth-wrapper">
                                    <ClientOnly>
                                    <apexchart height="215" type="line" :options="apexDashboard.options6" :series="apexDashboard.series6"></apexchart>
                                </ClientOnly>
                                </div>
                            </div>
                        </div>
