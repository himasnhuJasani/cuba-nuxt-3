                    ...
                    <div class="card crypto-main-card">
                        <div class="card-body">
                            <div class="deposit-wrap">
                                ...
                                </div><img src="@/assets/images/dashboard-4/crypto.png" alt="crypto">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body radial-progress-card">
                            <div>
                                ...
                                <div class="sale-details">
                                    <h5 class="font-primary mb-0">45,908</h5><span class="f-12 f-light f-w-500">
                                        <vue-feather type="arrow-up"></vue-feather>+5.7%
                                    </span>
                                </div>
                    ...
                    <div class="card widget-hover">
                        <div class="card-body radial-progress-card">
                            ...
                            <div class="radial-chart-wrap">
                                ...
                                <ClientOnly>
                                    <apexchart height="96.4" type="radialBar" :options="cryptoDashboard?.options2" :series="cryptoDashboard?.series2"></apexchart>
                                </ClientOnly>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            <vue-feather class="font-success me-2" type="trending-up"></vue-feather>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            <vue-feather class="font-danger me-2" type="trending-down"></vue-feather>
                                                            <div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex">
                                <div class="currency-chart-wrap">
                                    ...
                                    <ClientOnly>
                                        <apexchart height="115" type="line" :options="cryptoDashboard?.options3" :series="cryptoDashboard?.series3"></apexchart>
                                    </ClientOnly>
                                </div>
                            ...
                            <div class="card-body d-flex">
                                <div class="currency-chart-wrap">
                                    ...
                                    <ClientOnly>
                                        ...
                                        <apexchart height="115" type="line" :options="cryptoDashboard?.options4" :series="cryptoDashboard?.series4"></apexchart>
                                    </ClientOnly>
                            ...
                            <div class="card-body d-flex">
                                <div class="currency-chart-wrap">
                                    ...
                                    <ClientOnly>
                                        ...
                                        <apexchart height="115" type="line" :options="cryptoDashboard?.options5" :series="cryptoDashboard?.series5"></apexchart>
                                    </ClientOnly>
                    ...
                    <div class="card balance-box">
                        <div class="card-body">
                            <div class="balance-profile">
                                <div class="balance-img"><img src="@/assets/images/dashboard-4/user.png" alt="user vector"><a class="edit-icon" href="user-profile.html">
                                        <svg>
                                ...
                                <table class="table table-bordernone">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Anna K.</a><span class="f-light">To : 0x187...12bb</span></td>
                                            <td class="text-end"> <span class="font-success">+0.3BNB</span><span class="d-block f-light">29.09.22</span></td>
                                        </tr>
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle me-2" src="@/assets/images/dashboard/user/12.jpg" alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Guy Hawkins</a><span class="f-light">To : 0x187...12bb</span></td>
                                            <td class="text-end"> <span class="font-success">+0.3BNB</span><span class="d-block f-light">29.09.22</span></td>
                                        </tr>
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle me-2" src="@/assets/images/dashboard/user/10.jpg" alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Jenny Wilson</a><span class="f-light">To : 0x187...12bb</span></td>
                                            <td class="text-end"> <span class="font-danger">-0.1BNB</span><span class="d-block f-light">29.09.22</span></td>
                                        </tr>
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle me-2" src="@/assets/images/dashboard/user/11.jpg" alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Jacob B.</a><span class="f-light">To : 0x187...12bb</span></td>
                                            <td class="text-end"> <span class="font-success">+0.3BNB</span><span class="d-block f-light">29.09.22</span></td>
                                        </tr>
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle me-2" src="@/assets/images/dashboard/user/13.jpg" alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Esther Howard</a><span class="f-light">To : 0x187...12bb</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Leslie Alexander</a><span class="f-light">To : 0x187...12bb</span></td>
                                            <td class="text-end"> <span class="font-success">+0.3BNB</span><span class="d-block f-light">29.09.22</span></td>
                                        </tr>
                                    </tbody>
                                </table>
