            ...
            <div class="row">
                    ...
                    <div class="card social-profile">
                        <div class="card-body">
                            <div class="social-img-wrap">
                                <div class="social-img"><img src="@/assets/images/dashboard-5/profile.png" alt="profile"></div>
                                <div class="edit-icon">
                                    <svg>
                ...
                <div class="col-xl-12 col-md-6">
                    <div class="card mobile-app-card">
                        ...
                        <div class="card-body p-0 text-end"><img class="wavy" src="@/assets/images/dashboard-5/wave.png" alt=""><img src="@/assets/images/dashboard-5/mobile-img.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="card social-widget widget-hover">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="social-icons"><img src="@/assets/images/dashboard-5/social/2.png" alt="instagram icon"></div><span>Instagram</span>
                            ...
                            <div class="social-content">
                                ...
                                <div class="social-chart">
                                    ...
                                    <ClientOnly>
                                    <apexchart height="96.4" type="radialBar" :options="socialDashboard.options1" :series="socialDashboard.series1"></apexchart>
</ClientOnly>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card social-widget widget-hover">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="social-icons"><img src="@/assets/images/dashboard-5/social/3.png" alt="twitter icon"></div><span>Twitter</span>
                            ...
                            <div class="social-content">
                                ...
                                <div class="social-chart">
                                    ...
                                    <ClientOnly>
                                    <apexchart height="96.4" type="radialBar" :options="socialDashboard.options2" :series="socialDashboard.series2"></apexchart>
                                </ClientOnly>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <div class="subscriber-chart-container">
                                ...
                                <ClientOnly>
                                <apexchart height="255" type="line" :options="socialDashboard.options3" :series="socialDashboard.series3"></apexchart>
</ClientOnly>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-around">
                                        <div class="click-chart">
                                            ...
                                            <ClientOnly>
                                            <apexchart height="165" type="line" :options="socialDashboard.options4" :series="socialDashboard.series4"></apexchart>
                                            </ClientOnly>
                                        </div>
                                        <div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-around">
                                        <div class="click-chart">
                                            ...
                                            <ClientOnly>
                                            <apexchart height="165" type="line" :options="socialDashboard.options5" :series="socialDashboard.series5"></apexchart>
</ClientOnly>
                                        </div>
                                        <div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="change-currency">
                                            <vue-feather class="font-success me-1" type="trending-up"></vue-feather>45.6%
                                        </div>
                                    </td>
                                    <td>$9,786</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="change-currency">
                                            <vue-feather class="font-danger me-1" type="trending-down"></vue-feather>12.3%
                                        </div>
                                    </td>
                                    <td>$19,7098</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="change-currency">
                                            <vue-feather class="font-success me-1" type="trending-up"></vue-feather>65.6%
                                        </div>
                                    </td>
                                    <td>$90,986</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="change-currency">
                                            <vue-feather class="font-danger me-1" type="trending-down"></vue-feather>35.6%
                                        </div>
                                    </td>
                                    <td>$23,654</td>
                                    <td>
