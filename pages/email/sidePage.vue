                    ...
                    <div class="card-body">
                        <div class="email-app-sidebar">
                            ...
                            <ul class="nav main-menu" role="tablist">
                                <li class="nav-item"><nuxt-link class="btn-primary btn-block btn-mail show"  id="pills-darkhome-tab" to="/email/compose"><i class="icofont icofont-envelope me-2"></i> NEW MAIL</nuxt-link></li>
                                <li class="nav-item"><nuxt-link class="show" id="pills-darkprofile-tab" to="/email/mailInbox"><span class="title"><i class="icon-import"></i> Inbox</span><span class="badge pull-right">(236)</span></nuxt-link></li>
                                <li><nuxt-link to="/email/mailInbox"><span class="title"><i class="icon-folder"></i> All mail</span></nuxt-link></li>
                                <li><nuxt-link to="/email/readMail"><span class="title"><i class="icon-new-window"></i> Sent</span><span class="badge pull-right">(69)</span></nuxt-link></li>
