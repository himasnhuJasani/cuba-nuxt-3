...
<div class="col-md-12 project-list">
    <div class="card">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group mb-0 me-0"></div><nuxt-link class="btn btn-primary" to='/project/createproject'> <vue-feather class="me-1" type="plus-square"> </vue-feather>Create New Project</nuxt-link>
            </div>
        </div>
    </div>
</div>
