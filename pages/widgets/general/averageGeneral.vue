          ...
          <div class="card-body radial-progress-card"> 
            <div> 
              ...
              <div class="sale-details"> 
                <h5 class="font-primary mb-0">45,908</h5><span class="f-12 f-light f-w-500"><vue-feather type="arrow-up"></vue-feather>+5.7%</span>
              </div>
              <p class="f-light"> The point of using Lorem Ipsum</p>
            </div>
            <div class="radial-chart-wrap"> 
              <ClientOnly>
                <apexchart  type="radialBar" :options="cryptoDashboard?.options" :series="cryptoDashboard?.series"></apexchart>
              </ClientOnly>
            </div>
          </div>
        </div>
        ...
        <div class="card height-equal radial-height">
          <div class="card-body radial-progress-card"> 
            <div> 
              ...
              <div class="sale-details"> 
                <h5 class="font-primary mb-0">89.6%</h5><span class="f-12 f-light f-w-500"><vue-feather type="arrow-up"></vue-feather>+2.7%</span>
              </div>
              <p class="f-light"> The point of using Lorem Ipsum</p>
            </div>
            <div class="radial-chart-wrap"> 
